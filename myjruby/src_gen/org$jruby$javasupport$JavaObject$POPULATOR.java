...
public class org$jruby$javasupport$JavaObject$POPULATOR extends TypePopulator {
    public void populate(RubyModule cls, Class clazz) {
        ...
        javaMethod = new org.jruby.javasupport.JavaObject$INVOKER$i$1$0$aref(cls, Visibility.PUBLIC);
        populateMethod(javaMethod, 1, "aref", false, CallConfiguration.FrameNoneScopeNone, false, org.jruby.javasupport.JavaObject.class, "aref", org.jruby.runtime.builtin.IRubyObject.class, new Class[] {org.jruby.runtime.builtin.IRubyObject.class});
        ...
        javaMethod = new org.jruby.javasupport.JavaObject$INVOKER$i$3$0$afill(cls, Visibility.PUBLIC);
        populateMethod(javaMethod, 3, "afill", false, CallConfiguration.FrameNoneScopeNone, false, org.jruby.javasupport.JavaObject.class, "afill", org.jruby.runtime.builtin.IRubyObject.class, new Class[] {org.jruby.runtime.builtin.IRubyObject.class, org.jruby.runtime.builtin.IRubyObject.class, org.jruby.runtime.builtin.IRubyObject.class});
        ...
        javaMethod = new org.jruby.javasupport.JavaObject$INVOKER$i$2$0$aset(cls, Visibility.PUBLIC);
        populateMethod(javaMethod, 2, "aset", false, CallConfiguration.FrameNoneScopeNone, false, org.jruby.javasupport.JavaObject.class, "aset", org.jruby.runtime.builtin.IRubyObject.class, new Class[] {org.jruby.runtime.builtin.IRubyObject.class, org.jruby.runtime.builtin.IRubyObject.class});
        cls.addMethodAtBootTimeOnly("[]=", javaMethod);
