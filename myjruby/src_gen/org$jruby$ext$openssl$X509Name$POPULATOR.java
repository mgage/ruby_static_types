...
public class org$jruby$ext$openssl$X509Name$POPULATOR extends TypePopulator {
    public void populate(RubyModule cls, Class clazz) {
        ...
        javaMethod = new org.jruby.ext.openssl.X509Name$INVOKER$i$0$0$initialize(cls, Visibility.PUBLIC);
        populateMethod(javaMethod, -1, "initialize", false, CallConfiguration.FrameFullScopeNone, false, org.jruby.ext.openssl.X509Name.class, "initialize", org.jruby.runtime.builtin.IRubyObject.class, new Class[] {org.jruby.runtime.builtin.IRubyObject[].class, org.jruby.runtime.Block.class});
        ...
        javaMethod = new org.jruby.ext.openssl.X509Name$INVOKER$i$0$0$add_entry(cls, Visibility.PUBLIC);
        populateMethod(javaMethod, -1, "add_entry", false, CallConfiguration.FrameNoneScopeNone, false, org.jruby.ext.openssl.X509Name.class, "add_entry", org.jruby.runtime.builtin.IRubyObject.class, new Class[] {org.jruby.runtime.builtin.IRubyObject[].class});
